...
```bash
git clone https://github.com/llaurelson/AirBnB_clone.git
```
...
## Authors
<details>
    <summary>LawrenceOkoeguale</summary>
    <ul>
    <li><a href="https://www.github.com/llaurelson">Github</a></li>
    <li><a href="https://www.twitter.com/Laurencez7">Twitter</a></li>
    <li><a href="mailto:llaurelson@gmail.com">e-mail</a></li>
    </ul>
</details>
<details>
    <summary>Khadijah Osuolale</summary>
    <ul>
